...
for (i in 1:length(questionnaires)) {
  ...
  if (designctx$anchors > 0) {
    ...
    sGroupTitle = enc2utf8('Da li Vas recepti i savjeti o navedenim temama općenito zanimaju ili ne?')
  ...
  #    sAnchorQuestion1 = enc2utf8("Molimo odaberite što Vas zanima i što Vas ne zanima:")
      ...
      sAnchorSubQuestionTitle1 = paste(sAnchorQuestionTitle1, "sq1", sep = "") # ovo je kod u LimeSurvey i mora biti jedinstven na nivou surveya
      sAnchorSubQuestion1 = enc2utf8(paste("{getanchors(", anchi, ",", designctx$anchors, ",", question_subquestion_ids_in_q, ")}", sep = ""))
      
      limesurveyanchorsubquid = sAnchorSubQuestionTitle1
      ...
      limesurveyanchorqids[(limesurveyanchorqids$vers == i), anchi+1] = 
        paste(iNewID, "X", iGid21, "X", iQid1, limesurveyanchorsubquid, sep = "")
