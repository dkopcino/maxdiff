...
Možemo vidjeti da bi ponuda `r rownames(combs_r_f)[1]` dosegnula najviše ispitanika (kupili bi barem jedan proizvod iz ponude), njih `r combs_r_f[1, 1]`, što je `r round(combs_r_f[1, 1]/length(unique(cbc.df$resp.id)), 2)*100`% od ukupnog broja ispitanika, s time što bi ukupno bilo `r combs_r_f[1, 2]` (potencijalnih) kupovina.
